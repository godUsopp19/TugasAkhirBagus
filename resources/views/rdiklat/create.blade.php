...
<head>
    ...
    <title>Tambah Data Realisasi Diklat</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('rdiklat.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('Pelaks') is-invalid @enderror" name="Pelaks" value="{{ old('Pelaks') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('JmlPes') is-invalid @enderror" name="JmlPes" value="{{ old('JmlPes') }}" placeholder="Masukkan Jumlah Peserta">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('WktM') is-invalid @enderror" name="WktM" value="{{ old('WktM') }}" placeholder="Masukkan Waktu Mulai">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('WktK') is-invalid @enderror" name="WktK" value="{{ old('WktK') }}" placeholder="Masukkan Waktu Selesai">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('Bidang') is-invalid @enderror" name="Bidang" value="{{ old('Bidang') }}" placeholder="Masukkan Bidang">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('BiayaD') is-invalid @enderror" name="BiayaD" value="{{ old('BiayaD') }}" placeholder="Masukkan Biaya Diklat">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('BiayaS') is-invalid @enderror" name="BiayaS" value="{{ old('BiayaS') }}" placeholder="Masukkan SPPD">
