        ...
        <div class="col-md-12">
            ...
            <div class="card border-0 shadow rounded">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('rdiklat.create') }}" class="btn btn-md btn-success mb-3">Add Realisasi</a>
                        ...
                        <table id="table_id" class="table table-responsive display">
                            <thead>
                              <tr>
                                ...
                                <th scope="col">Tanggal Mulai Pelaksanaan⠀</th>
                                <th scope="col">Tanggal Berakhirnya Pelaksanaan⠀</th>
                                <th scope="col">Bidang</th> 
                                <th scope="col">Biaya Diklat⠀⠀</th>
                                <th scope="col">Biaya SPPD⠀⠀</th>
                            ...
                            <tbody>
                              @forelse ($rdiklat as $data)
                                <tr>
                                    ...
                                    <td>{{ sprintf('Rp %s', number_format($data->BiayaD, 0, ',', '.'))}}</td>
                                    <td>{{ sprintf('Rp %s', number_format($data->BiayaS, 0, ',', '.'))}}</td>
                                    <td>{{ sprintf('Rp %s', number_format($data->BTotal, 0, ',', '.'))  }}</td>
                                    <td>{{ $data->Peserta}}</td>
                                    <td>{{ $data->Tahun}}</td>
                                    <td>{{ $data->Status}}</td>
                                    @can('admin')
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('rdiklat.destroy', $data->id) }}" method="POST">
                                            <a href="{{ route('rdiklat.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
                              ...
                              @empty
                                  <div class="alert alert-danger">
                                      Data Realisasi Tahun ini belum Tersedia.
                                  </div>
                              @endforelse
                            </tbody>
                          </table>
