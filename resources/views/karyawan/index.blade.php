        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <a href="{{ route('karyawan.create') }}" class="btn btn-md btn-success mb-3">Add Karyawan</a>
                            ...
                            <tbody>
                              @forelse ($karyawans as $karyawan)
                                <tr>
                                    ...
                                    <td>{{ $karyawan->Bidangnsub}}</td>
                                    <td>{{ $karyawan->Unit}}</td>
                                    <td>{{ $karyawan->Email}}</td>
                                    <td class="text-center">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('karyawan.destroy', $karyawan->id_k) }}" method="POST">
                                            <a href="{{ route('karyawan.edit', $karyawan->id_k) }}" class="btn btn-sm btn-primary">EDIT</a>
                                            @csrf
                                            @method('DELETE')
