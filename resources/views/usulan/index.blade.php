        ...
        <div class="row flex-row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    @endif
                    <div class="card-body">
                        <a href="{{ route('usulan.create') }}" class="btn btn-md btn-success mb-3">Add Usulan</a>
                                    ...
                                    @forelse ($usulans as $usulan) 
                                      <tr>
                                          ...
                                          <td class="text-center">
                                              <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('usulan.destroy', $usulan->id) }}" method="POST">
                                                  <a href="{{ route('usulan.edit', $usulan->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                  @csrf
                                                  @method('DELETE')
