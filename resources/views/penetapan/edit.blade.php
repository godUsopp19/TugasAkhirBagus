        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('penetapan.update', $penetapan->id_pen) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="form-group">
                                <label class="font-weight-bold">Tahun</label>
                                <input type="text" class="form-control @error('Tahun') is-invalid @enderror" name="Tahun" value="{{$penetapan->Tahun }}" placeholder="Masukkan Tahun">
