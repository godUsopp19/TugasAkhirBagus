                ...
                <div class="card border-0 shadow rounded">
                    ...
                    <div class="card-body">
                        <div class="table-wrapper">
                          <a href="{{ route('penetapan.create') }}" class="btn btn-md btn-success mb-3">Add Penetapan</a>
                            <table id="table_id" class="table table-responsive display">
                                <thead>
                                  ...
                                  <tbody>
                                    @forelse ($penetapans as $penetapan) 
                                      <tr>
                                          <td>
                                              {{$penetapan->Tahun}}
                                          </td>
                                          <td>
                                            {{ sprintf('Rp %s', number_format($penetapan->Penetapan, 0, ',', '.'))}}
                                        </td>
                                          <td class="text-center">
                                              <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('penetapan.destroy', $penetapan->id_pen) }}" method="POST">
                                                  <a href="{{ route('penetapan.edit', $penetapan->id_pen) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                  @csrf
                                                  @method('DELETE')
