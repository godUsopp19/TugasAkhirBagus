...
<body>
  <div class="container-scroller">
        ...
        <div class="row flex-row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    @endif
                    <div class="card-body">
                        <a href="{{ route('sertifikat.create') }}" class="btn btn-md btn-success mb-3">Add Sertifikat</a>
                            ...
                            <table id="table_id" class="table display">
                                <thead>
                                  <tr>
                                    ...
                                    <th scope="col">Bidang/Sub Bidang</th>
                                ...
                                <tbody>
                                  @forelse ($datas as $data) 
                                    <tr>
                                        ...
                                        <td>{{ $data->Fungsi }}</td>
                                        <td>{{ $data->NoSertif }}</td>
                                        <td>{{ $data->TglSertif}}</td>
        
                                        <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $data->Deadline)->format('d-m-Y')}}</td>
                                        
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('sertifikat.destroy', $data->id_s) }}" method="POST">
                                                <a href="{{ route('sertifikat.edit', $data->id_s) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                @csrf
                                                @method('DELETE')
    ...
    if( data[13] == "Reminder Ke-2" ) {
      $(row).addClass( 'orange' );
    }
    if( data[13] == "Reminder Ke-1" ) {
      $(row).addClass( 'yellow' );
    }
    if( data[13] == "Aman" ) {
    $(row).addClass( 'green' );
