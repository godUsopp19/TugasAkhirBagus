                    ...
                    <div class="card-body">
                        <form action="{{ route('sertifikat.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('Judul') is-invalid @enderror" name="Judul" value="{{ old('Judul') }}" placeholder="Masukkan Judul Sertifikat">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('Fungsi') is-invalid @enderror" name="Fungsi" value="{{ old('Fungsi') }}" placeholder="Masukkan Fungsi Sertifikat">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('NoSertif') is-invalid @enderror" name="NoSertif" value="{{ old('NoSertif') }}" placeholder="Masukkan Nomor Sertifikat">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('TglSertif') is-invalid @enderror" name="TglSertif" value="{{ old('TglSertif') }}" placeholder="Masukkan Tanggal Sertifikat">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('Deadline') is-invalid @enderror" name="Deadline" value="{{ old('Deadline') }}" placeholder="Masukkan Tanggal Expired Sertifikat">
