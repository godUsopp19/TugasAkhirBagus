...
<head>
  ...
  <title>Perencanaan Diklat</title>
  <!-- plugins:css -->
  ...
  <link rel="stylesheet" type="text/css" href="../../assets/vendors/DataTables2/datatables.min.css"/>
 
  <script type="text/javascript" src="../../assets/vendors/DataTables2/datatables.min.js"></script>
        ...
        <div class="row flex-row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    ...
                    @endif
                    <div class="card-body">
                        <a href="{{ route('pdiklat.create') }}" class="btn btn-md btn-success mb-3">Tambahkan Perencanaan</a>
                        
                            <table id="table_id" class="table table-responsive display order-column">
                                <thead>
                                  <tr>
                                    <th scope="col">Program Diklat/Sertifikasi</th>
                                    <th scope="col">Sasaran/Tujuan Diklat</th>
                                    <th scope="col">Prioritas ⠀</th>
                                    <th scope="col">Perkiraan Waktu Pelaksanaan ⠀</th>
                                    <th scope="col">Perkiraan Waktu Selesai ⠀</th>
                                    <th scope="col">Tahun Perencanaan</th>
                                    <th scope="col">Provider</th>
                                    <th scope="col">Jumlah Peserta ⠀</th> 
                                    <th scope="col">Usulan Sasaran</th>
                                    <th scope="col">Bidang</th>
                                    <th scope="col">Harga Satuan/Paket ⠀</th>
                                ...
                                <tbody>
                                  @forelse ($datas as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->RenP}}</td>
                                        <td>{{ $data->Bidang}}</td>
                                        <td>{{ sprintf('Rp %s', number_format($data->HargSat, 0, ',', '.'))}}</td>
                                        <td>{{ sprintf('Rp %s', number_format($data->SPPD, 0, ',', '.'))}}</td>
                                        <td>{{ $data->Peserta}}</td>
                                        <td>{{ sprintf('Rp %s', number_format($data->Total, 0, ',', '.'))}}</td>
                                        <td>{{ $data->Rev}}</td>
                                        <td>{{ $data->LM}}</td>
                                        <td>{{ $data->Approval}}</td>
                                        <td>{{ $data->Alasan}}</td>
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('pdiklat.destroy', $data->id_P) }}" method="POST">
                                                <a href="{{ route('pdiklat.edit', $data->id_P) }}" class="btn btn-sm btn-primary">EDIT</a>
                                                @csrf
                                                @method('DELETE')
                                  ...
                                  @empty
                                      <div class="alert alert-danger">
                                          Data Perencanaan belum Tersedia.
                                      </div>
                                  @endforelse
                                </tbody>
                              </table> 
                                ...
                                <tbody>
                                  @forelse ($data10 as $data)
                                    ...
                                    <td>{{ $data->Alasan}}</td>
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('pdiklat.destroy', $data->id_P) }}" method="POST">
                                                <a href="{{ route('pdiklat.edit', $data->id_P) }}" class="btn btn-sm btn-primary">APPROVAL</a>
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-danger">HAPUS</button>
                                            </form>
                            ...
                            <table id="table_id" class="table table-responsive display">
                                ...
                                <tbody>
                                  @forelse ($data1 as $data)
                                    ...
                                    <td>{{ $data->Alasan}}</td>
                                        <td>
                                        <a href="{{ route('pdiklat.edit', $data->id_P) }}" class="btn btn-sm btn-primary">REVISI</a>
                                        </td>   
                                    </tr>
                                  @empty
                                      <div class="alert alert-danger">
